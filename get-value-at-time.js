(function(){
	...
	if(firefoxVersion !== false){
		...
		// fix value not returning other, than the defaultValue
		...
		descriptor.get = function(value){
			return this.getValueAtTime(value, 0); <- how to inject the ctx.currentTime here?
		};
		*/
		...
		/*
		// set all the above for only these nodes
		GainNode
		OscillatorNode
		PeriodicWave
		*/
